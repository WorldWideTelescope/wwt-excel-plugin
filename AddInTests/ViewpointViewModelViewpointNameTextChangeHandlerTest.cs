//-----------------------------------------------------------------------
// <copyright file="ViewpointViewModelViewpointNameTextChangeHandlerTest.cs" company="Microsoft Corporation">
...
{
    /// <summary>
    /// This is a test class for ViewpointViewModelViewpointNameTextChangeHandlerTest and is intended
    /// to contain all ViewpointViewModelViewpointNameTextChangeHandlerTest Unit Tests
    /// </summary>
    [TestClass()]
    public class ViewpointViewModelViewpointNameTextChangeHandlerTest
    {
        /// <summary>
        ...
        /// <summary>
        /// A test for ViewpointNameTextChangeHandler Constructor
        /// </summary>
        [TestMethod()]
